...
>
  <head>
    ...
    <title>Registrasi - Kost Wisma</title>
            ...
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center">
                <a href="{{ url('/') }}" class="app-brand-link gap-2">
                  <span class="demo text-body fw-bolder">Kost Wisma</span>
                </a>
              </div>
              <!-- /Logo -->
              <h4 class="mb-2">Welcome to Kost Wisma! 👋</h4>
                ...
                <div class="mb-3">
                    ...
                    <div class="row">
                        <div class="col-7"><input
                            ...
                            autofocus
                            /></div>
                        <div class="col-5"><a class="btn btn-info" href="{{ url('https://wa.me/6285333571245') }}">Minta Token</a></div>
                      </div>
                @error('token')
                    <span class="text-danger" style="display: block;">
                        {{ $message }}
